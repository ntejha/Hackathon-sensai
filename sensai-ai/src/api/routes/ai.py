...
async def resume_pending_course_structure_generation_jobs():
    try:
        ...
        print(f"Error in resume_pending_course_structure_generation_jobs: {e}")
        # Don't re-raise to prevent startup failures
...
async def resume_pending_task_generation_jobs():
    try:
        ...
        print(f"Error in resume_pending_task_generation_jobs: {e}")
        # Don't re-raise to prevent startup failures
